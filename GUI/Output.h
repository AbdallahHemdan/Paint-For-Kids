...
public:
	...
	void DrawRho(Point P1, Point P2, GfxInfo RhoGfxInfo, bool selected = false) const; //Draw a RHOMBUS
	void DrawTri(Point P1, Point P2, Point P3, GfxInfo TriGfxInfo, bool selected = false) const;          //Draw a triangle
	void DrawElli(Point P1, Point P2, GfxInfo ElliGfxInfo, bool selected) const; // Draw an Ellipse
